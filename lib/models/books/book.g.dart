...
const BookSchema = CollectionSchema(
  ...
  estimateSize: _booksEstimateSize,
  serialize: _booksSerialize,
  deserialize: _booksDeserialize,
  deserializeProp: _booksDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {},
  embeddedSchemas: {},
...
Id _booksGetId(Book object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _booksGetLinks(Book object) {
  return [];
}

void _booksAttach(IsarCollection<dynamic> col, Id id, Book object) {
  object.id = id;
}

extension BooksQueryWhereSort on QueryBuilder<Book, Book, QWhere> {
...
extension BooksQueryWhere on QueryBuilder<Book, Book, QWhereClause> {
...
extension BooksQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeEqualTo(
    String value, {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'barcode',
        value: '',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> barcodeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'barcode',
        value: '',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> qtyEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'qty',
        value: value,
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> qtyGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> qtyLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> qtyBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BooksQueryObject on QueryBuilder<Book, Book, QFilterCondition> {}

extension BooksQueryLinks on QueryBuilder<Book, Book, QFilterCondition> {}

extension BooksQuerySortBy on QueryBuilder<Book, Book, QSortBy> {
  QueryBuilder<Book, Book, QAfterSortBy> sortByBarcode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'barcode', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByBarcodeDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> sortByQty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qty', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByQtyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BooksQuerySortThenBy on QueryBuilder<Book, Book, QSortThenBy> {
  QueryBuilder<Book, Book, QAfterSortBy> thenByBarcode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'barcode', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByBarcodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'barcode', Sort.desc);
    });
  }
  ...
  QueryBuilder<Book, Book, QAfterSortBy> thenByQty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qty', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByQtyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qty', Sort.desc);
    });
  }
...
extension BooksQueryWhereDistinct on QueryBuilder<Book, Book, QDistinct> {
  QueryBuilder<Book, Book, QDistinct> distinctByBarcode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QDistinct> distinctByQty() {
    return QueryBuilder.apply(this, (query) {
...
extension BooksQueryProperty on QueryBuilder<Book, Book, QQueryProperty> {
  ...
  QueryBuilder<Book, String, QQueryOperations> barcodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, int, QQueryOperations> qtyProperty() {
    return QueryBuilder.apply(this, (query) {
